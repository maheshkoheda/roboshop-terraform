...
module "alb" {
  source   = "git::https://github.com/maheshkoheda/tf-module-alb.git"
...
#module "docdb" {
#  source   = "git::https://github.com/maheshkoheda/tf-module-docdb.git"
#  tags = var.tags
#  env = var.env
#  for_each = var.docdb
...
#
#module "elasticache" {
#  source   = "git::https://github.com/maheshkoheda/tf-module-elasticache.git"
#  tags = var.tags
#  env = var.env
